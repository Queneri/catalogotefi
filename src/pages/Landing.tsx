          ...
          <div className="relative overflow-hidden rounded-lg border border-foreground/10 bg-gradient-to-br from-card via-card to-muted/30 p-6 md:p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm md:text-base">
                Mantiene la calidad y autenticidad de la marca, pero no ingresó a locales por no cumplir sus estándares ultra exigentes de terminación. No afecta la funcionalidad; solo reduce el precio. <span className="text-foreground font-medium">Mismo lujo, valor más accesible.</span>
              </p>
            </div>
          </div>
        </div>
